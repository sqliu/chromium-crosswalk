...
#ifndef CONTENT_COMMON_GPU_CLIENT_WEBGRAPHICSCONTEXT3D_COMMAND_BUFFER_BROWSER_IMPL_H_
#define CONTENT_COMMON_GPU_CLIENT_WEBGRAPHICSCONTEXT3D_COMMAND_BUFFER_BROWSER_IMPL_H_
...
extern const size_t kDefaultCommandBufferSize;
extern const size_t kDefaultStartTransferBufferSize;
extern const size_t kDefaultMinTransferBufferSize;
extern const size_t kDefaultMaxTransferBufferSize;

class WebGraphicsContext3DBrowserErrorMessageCallback;

class WebGraphicsContext3DCommandBufferBrowserImpl
 ...
 public:
  ...
  virtual ~WebGraphicsContext3DCommandBufferBrowserImpl();
  ...
  // Create & initialize a WebGraphicsContext3DCommandBufferBrowserImpl.
  // Return NULL on any failure.
  static WebGraphicsContext3DCommandBufferBrowserImpl* CreateOffscreenContext(
      GpuChannelHostFactory* factory,
 ...
 private:
  ...
  // WebGraphicsContext3DCommandBufferBrowserImpl configuration attributes.
  // Those in the 16-bit range are the same as used by EGL. Those outside the
  // 16-bit range are unique to Chromium. Attributes are matched using a closest
  // fit algorithm.
  enum Attribute {
    ALPHA_SIZE                = 0x3021,
    BLUE_SIZE                 = 0x3022,
  ...
  friend class WebGraphicsContext3DBrowserErrorMessageCallback;
  ...
  scoped_ptr<WebGraphicsContext3DBrowserErrorMessageCallback>
  ...
  base::WeakPtrFactory<WebGraphicsContext3DCommandBufferBrowserImpl>
      weak_ptr_factory_;
...
#endif  // CONTENT_COMMON_GPU_CLIENT_WEBGRAPHICSCONTEXT3D_COMMAND_BUFFER_BROWSER_IMPL_H_
